...
public class GalleryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        swipeContainer.setOnRefreshListener(this::findFiles);
    ...
    public void findFiles(){
        ...
        String path = Objects.requireNonNull(requireActivity().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS)).toString();

        File directory = new File(path);
        videoFiles = new ArrayList<>(Arrays.asList(Objects.requireNonNull(directory.listFiles())));
        videoFiles.sort((o1, o2) -> o2.getPath().compareTo(o1.getPath()));
